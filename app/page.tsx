...
export default function Home() {
  return (
    <div className="flex w-full flex-col items-center ">
      <Encard title="Qui sommes-nous ?" imageSrc="/assets/pics/DSC03889.JPG">
        <p>
      ...
      <Encard title="Sensibilisation" imageSrc="/assets/pics/DSC8146.jpg">
      ...
      <Encard title="recherche et développement" imageSrc="/assets/pics/eolienne.jpg">
        <ul className='list-disc list-inside space-y-1'>
